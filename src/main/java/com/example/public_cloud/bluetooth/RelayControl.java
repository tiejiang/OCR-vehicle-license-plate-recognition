package com.example.public_cloud.bluetooth;
...
import com.example.public_cloud.MyCaremaActivity;
import com.example.public_cloud.R;
...
//    private Vibrator mVibrator;
    ...
    private byte[] commandByte = new byte[1]; //向下位机发送的指令
...
//        mVibrator = (Vibrator) getSystemService(Context.VIBRATOR_SERVICE);
    ...
    protected void onResume() {
        ...
        sendCommand(commandByte);
        Log.d("TIEJIANG", "onResume is_detect= " + is_detect);
    }
        ...
        public void dispatchMessage(Message msg) {
            switch(msg.what){
                ...
                case 01:
                    ...
                    if(info.contains("S") && info.contains("C") && info.contains("E")  && !is_detect){
                        Intent mTakePictureIntent = new Intent(RelayControl.this, MyCaremaActivity.class);
                        startActivity(mTakePictureIntent);
                        is_detect = true;
//                        finish();
                        Log.d("TIEJIANG", "goto  MyCaremaActivity");
                    }
//                    AnalyzeData(info);
                    break;
